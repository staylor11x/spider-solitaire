...
type Colors struct {
	...
	CardTextBlack     color.RGBA
	CardTextRed       color.RGBA
	CardFaceUpColor   color.RGBA
	CardFaceDownColor color.RGBA
	CardTextColor     color.RGBA
...
var DefaultTheme = Theme{
	...
	Colors: Colors{
		...
		CardTextBlack:     color.RGBA{R: 0, G: 0, B: 0, A: 255},
		CardTextRed:       color.RGBA{R: 200, G: 0, B: 0, A: 255},
		CardTextColor:     color.RGBA{R: 0, G: 0, B: 0, A: 255},
